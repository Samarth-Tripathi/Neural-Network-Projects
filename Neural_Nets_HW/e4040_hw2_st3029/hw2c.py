...
#test_mlp_dropout(1,0.00,0.0001,1000,20,500,True,2) 
def test_mlp_dropout(learning_rate, L1_reg, L2_reg, n_epochs,
             batch_size, n_hidden, dropout_p, verbose, hidlayers, acttest=T.tanh):
    ...
    #params_rescale = [ hiddenlayer_one.params[0], hiddenlayer_two.params[0] ]
    #params = params_rescale
    #params = [hiddenlayer_one.params , hiddenlayer_two.params , logRegressionLayer.params]
    ...
    cost = (
        ...
        + np.cast[theano.config.floatX](L1_reg) * L1
        + np.cast[theano.config.floatX](L2_reg) * L2_sqr
    )
    ...
    patience = 20000000  # look as this many examples regardless
...
if __name__ == '__main__':
    ...
    for i in [1,2,3,4,5,6,7,8]:
        ...
        del com
    print(y) '''
    test_mlp_dropout(0.01,0.00,0.0001,500,20,500,0.7,True,2) 
